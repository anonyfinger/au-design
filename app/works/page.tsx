...
export default function WorksPage() {
  return (
    <div className={styles.wrapper}>
      <Header />
      <main id="main-content" className={styles.main} aria-label="작업물 · 제작 사례">
        <section className={styles.platformPageHero} aria-labelledby="works-page-hero-title">
          <div className={styles.container}>
            <Breadcrumb items={[{ label: "홈", href: "/" }, { label: "제작 사례" }]} />
            <h1 id="works-page-hero-title" className={styles.platformPageLead}>
        ...
        <section className={styles.section} aria-labelledby="works-page-title">
          <div className={styles.container}>
            <h2 id="works-page-title" className={styles.sectionTitle}>
              작업물 갤러리
            </h2>
            <ul className={styles.worksPageGrid} aria-label="제작 사례 갤러리">
              {WORKS_ORDERED.map((work, index) => (
                <li
                  key={work.src}
                  className={
                    "wide" in work && work.wide
                      ? `${styles.worksPageCard} ${styles.worksPageCardWide}`
                      : styles.worksPageCard
                  }
                >
                  <WorkImage
                    src={work.src}
            ...
            <p className={styles.worksPageCta}>
              제작 문의·견적은{" "}
              <a
                href={TELEGRAM_URL}
                target="_blank"
