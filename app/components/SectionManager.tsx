    ...
    >
      <div className={styles.container}>
        <div className={styles.sectionHead}>
          <p className={styles.sectionLabel}>연락처</p>
          <h2 id="contact-title" className={styles.sectionTitle}>
            문의하기
          </h2>
          <p className={styles.sectionDesc}>
            어디보다 완성도 높은 퀄리티로 제작해 드립니다. 20% 할인 이벤트 적용 중 · 문의 주시면 시안 제공 및 상담을 해드리며, 배너 제작 문의·견적·예약은 텔레그램으로 보내 주세요.
          </p>
        </div>
        <div className={styles.contactCard}>
          ...
          <p className={styles.contactId}>
            텔레그램 ID: <strong>@AuDesign</strong>
          </p>
          <a
            href={TELEGRAM_URL}
            target="_blank"
