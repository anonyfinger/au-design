...
const STEPS = [
  {
    emoji: "💬",
    title: "텔레그램으로 문의",
    desc: "~~@AUDesignlab~~으로 플랫폼·업종·수량을 보내 주시면 견적을 **바로** 안내해 드립니다.",
    highlight: "평균 응답 시간 1시간 이내",
  },
  {
    emoji: "📋",
    title: "견적 확인 & 구성 확정",
    desc: "컷수·구성 기준으로 **맞춤 견적**을 안내해 드립니다. **코스와 상세 구성**을 함께 결정합니다.",
    highlight: "맞춤 견적 안내",
  },
  {
    emoji: "🎨",
  ...
  },
  {
    emoji: "📦",
    title: "완성본 납품",
    desc: "플랫폼 규격에 맞는 **고해상도 파일**로 납품합니다. **바로 업로드 가능**한 형태로 제공합니다.",
    highlight: "즉시 사용 가능",
  },
];
    ...
    >
      <div className="container">
          ...
          {STEPS.map((step) => (
            <li key={step.title} className="reservationStepItem">
              ...
              <div className="stepBody">
                ...
                <p className="stepDesc">{hl(step.desc)}</p>
              </div>
            </li>
          ))}
        </ol>
        <div className="sectionCta">
          ...
          <p className="reservationCtaNote">텔레그램 <span className="emWarm">@AUDesignlab</span> · 평균 <span className="emWarm">1시간 내</span> 응답</p>
        </div>
      </div>
    </section>
  );
